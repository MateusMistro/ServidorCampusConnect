...
public class PedidoDeValidacaoDeEstabelecimento extends Comunicado {
    private String cnpj;
    private String name;
    ...
    public PedidoDeValidacaoDeEstabelecimento(String cnpj, String name,String photo, String description, String openingHours) {
        this.cnpj = cnpj;
        this.name = name;
        this.photo = photo;
